...
# 1) Eski fiyati sayfadaki rastgele yuksek rakamlardan alma.
...
# 2) Sayfanin ilan ettigi indirim oranini yakala.
...
# 3) JSON-LD isimsizsa gercek sayfa basligini kullan.
...
# Akakce gecmisinden guvenilir bir veri cikarsa baseline'a aday yap. Tek bir yuksek fiyat asla yeterli degil.
...
# ilan edilen indirim varsa daha yuksek hesaplamayi gecersiz kil.
...
# 6) process.browser main dongusunde set edilir.
